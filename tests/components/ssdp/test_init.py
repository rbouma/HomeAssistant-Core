...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "mock-domain",
            (DiscoveryKey(domain="ssdp", key="uuid:mock-udn", version=1),),
        ),
        # Matching discovery key
        (
            "mock-domain",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "mock-domain",
            (DiscoveryKey(domain="bluetooth", key="uuid:mock-udn", version=1),),
        ...
        (
            "mock-domain",
            (DiscoveryKey(domain="ssdp", key="uuid:mock-udn", version=2),),
            config_entries.SOURCE_IGNORE,
            "mock-unique-id",
        ),
    ],
...
async def test_ssdp_rediscover_no_match_2(
    mock_get_ssdp,
    hass: HomeAssistant,
    mock_flow_init,
    entry_domain: str,
