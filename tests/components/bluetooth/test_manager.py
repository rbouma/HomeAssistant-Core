...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "switchbot",
            (DiscoveryKey(domain="bluetooth", key="44:44:33:11:23:45", version=1),),
        ),
        # Matching discovery key
        (
            "switchbot",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "switchbot",
            (DiscoveryKey(domain="bluetooth", key="44:44:33:11:23:45", version=2),),
            config_entries.SOURCE_IGNORE,
            "mock-unique-id",
        ),
    ],
...
async def test_bluetooth_rediscover_no_match_2(
    hass: HomeAssistant,
    entry_domain: str,
    entry_discovery_keys: tuple,
    entry_source: str,
